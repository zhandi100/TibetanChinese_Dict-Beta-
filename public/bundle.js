...
/***/ function(module, exports, __webpack_require__) {
	...
	var TermSearch = __webpack_require__(159);
	var Definitions = __webpack_require__(181);
...
/***/ function(module, exports) {
	...
	var search = function search(tofind) {
		var out = [];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var actions = Reflux.createActions(['showDef']);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Definitions = React.createClass({
		...
		onStore: function onStore(entry, page, tdef, cdef, abb1, abb2, abb3, syn1, syn2, syn3, note) {
			if (abb1 !== '') abb1 = '【' + abb1 + '】';
			if (abb2 !== '') abb2 = '【' + abb2 + '】';
			if (abb3 !== '') abb3 = '【' + abb3 + '】';
			if ((syn1 || syn2 || syn3) == '') {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var store = Reflux.createStore({
		listenables: actions,
		data: [],
		onShowDef: function onShowDef(termpos) {
